...
export const enqueueNotification = ({
  ...
  positions: reduceAtPosition(positions, vertical, horizontal, ({
    queue
  }) => ({
    queue: [...queue, {
      key,
...
export const closeNotification = ({
  ...
  positions: reduceAtPosition(positions, vertical, horizontal, ({
    ...
    notifications: notifications.map(notification => notification.key === key ? { ...notification,
...
export const dismissNotification = ({
  ...
  history: history.map(notification => notification.key === key ? { ...notification,
    destroy: true
  } : notification)
});
export const dismissNotifications = ({
  ...
  clearing: true,
  history: history.map(notification => ({ ...notification,
    destroy: true
  }))
});
